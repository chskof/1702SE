package coreJava.Annotation.bytecodeAnnotations;
...
/**
 * Adds "entering" logs to all methods of a class that have the LogEntry
 * annotation.
 * 
...
public class EntryLogger {
	...
	/**
	 * Constructs an EntryLogger that inserts logging into annotated methods of a
	 * given class.
	 * 
	 * @param cg
	 *            the class
	 ...
	 *            the method
	 * @param loggerName
	 *            the name of the logger to call
	 */
